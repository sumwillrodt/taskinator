...
var taskFormHandler = function(event) {
    ...
    //check if input values are empry strings
...
var deleteTask = function(taskId) {
    var taskSelected = document.querySelector(".task-item[data-task-id='" + taskId + "']");taskSelected.remove();
}
...
var taskStatusChangeHandler = function(event) {
    ...
    //get current selected option's value and make lowercase
